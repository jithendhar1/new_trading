...
<!-- Main Wrapper -->
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="col">
								...
								<h3 style="color: white;" class="page-title">About US </h3>
								 <ul class="breadcrumb">
							   <li style="color: white;" class="breadcrumb-item active">About Us</li>
								</ul>
							</div>
      ...
      <section id="about" class="about" style="padding-bottom: 0;">
          <div class="container">
              <div class="section-title" data-aos="zoom-out">
                  <p style="color: white; text-align: center;">Trading</p><br>
              </div>
              <div class="row content" data-aos="fade-up" style="display: flex; flex-direction: row; align-items: center;">
                  <div style="color: white;" class="col-lg-6" style="text-align: justify;">
  ...
  <br><div>
	<h3 style="color: white;" class="page-title">Contact US </h3><br>
	<div style="color: white;" style="margin-left: 60px;">
